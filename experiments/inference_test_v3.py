...
PROMPTS = [
    "AINBN3tpDb, moderate blight, 55.6%",
    "AINBN3tpDb, severe blight, 100.0%",
    "AINBN3tpDb, mild blight, 10.0%",
    "AINBN3tpDb, no blight, 0.0%",
]
...
def main():
    parser = argparse.ArgumentParser(description="Batch inference with Stable Diffusion ControlNet")
    ...
    parser.add_argument("--base_model_path", type=str, default="sd-legacy/stable-diffusion-v1-5", help="Base SD model path")
    parser.add_argument("--controlnet_weights_path", type=str, default="controlnet_training_output/v3", help="ControlNet weights path")
